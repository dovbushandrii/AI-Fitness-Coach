		...
		<>
			<div className="mb-2 flex items-center justify-between bg-white p-4 md:p-8">
				...
				<Link href="/trainings/new" passHref>
					<div className="text-md inline-flex cursor-pointer items-center justify-center rounded-md border border-transparent bg-[#7b52b9] px-4 py-2 font-medium text-white shadow-sm transition-colors hover:bg-[#6a46a5]">
						+ New Plan
					</div>
				</Link>
			</div>
