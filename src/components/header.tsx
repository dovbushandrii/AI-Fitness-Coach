...
//
// 	return (
// 		<header className="flex w-full items-center justify-between bg-gradient-to-br from-indigo-400 to-purple-600 px-6 py-4 text-white">
...
// 									className={`group flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition-all duration-200 ${
// 										isActive
// 											? 'bg-white/20 text-white shadow-inner' // Active state
// 											: 'text-indigo-50 hover:bg-white/10 hover:text-white' // Inactive state
// 									}`}
// 								>
// 									<Icon
// 										size={16}
